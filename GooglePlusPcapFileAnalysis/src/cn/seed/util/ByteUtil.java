...
public class ByteUtil {
	public static void main(String[] args)
	{
		...
		//System.out.println(unsigned4BytesToLong(ll));
		//System.out.println(byte2Int(ll));
		
		//System.out.println("$$$$$$$$$$$$$$$$$$$$$$");
		String str = "FE234857E3";
		byte[] bbbbb = hexFullString2Bytes(str);
		//System.out.println(byte2HexStr(bbbbb));
	}
	...
	public static long unsigned4BytesToLong_high(byte[] buf) {
        int firstByte = 0;
        int secondByte = 0;
        int thirdByte = 0;
        int fourthByte = 0;
        ...
        thirdByte = (0x000000FF & ((int) buf[index + 2]));
        fourthByte = (0x000000FF & ((int) buf[index + 3]));
        return ((long) (firstByte  | secondByte << 8 |
